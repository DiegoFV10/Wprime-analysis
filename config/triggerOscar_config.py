...
class Config():
    ...
    def add_processes(self):
        ...
        processes = [
            ...
            # JetMET
            Process("JetMET_Data2022", Label("Data"), color=(0, 0, 0)),
    ...
    def add_features(self):
        ...
        ### Histograms for MET trigger efficiency plots ###

        features_efficiency = [

            Feature("METprime", "METprime", 
                binning=(20, 0, 1000),
                x_title=Label("p_{T}^{#mu + MET}"),
                units="GeV"),

            Feature("PuppiMETprime", "sqrt( PuppiMET_pt*PuppiMET_pt + Muon_pt.at(goodMuIdx)*Muon_pt.at(goodMuIdx)*(Muon_isPFcand.at(goodMuIdx) == 1) + 2*PuppiMET_pt*Muon_pt.at(goodMuIdx)*cos(PuppiMET_phi - Muon_phi.at(goodMuIdx))*(Muon_isPFcand.at(goodMuIdx) == 1) )", 
                binning=(20, 0, 1000),
                x_title=Label("p_{T}^{#mu + MET}"),
                units="GeV"),
        ...
        features_selection = [
            ...
            Feature("jet1_btagScore", "Jet_btagDeepFlavB.at(goodJets.at(0))", binning=(50, 0, 1),
                selection="nGoodJets > 0 && METprime > 250",
            ...
            Feature("jet1_eta", "Jet_eta.at(goodJets.at(0))", binning=(50, -2.4, 2.4),
                selection="nGoodJets > 0 && METprime > 250",
        ...
        return ObjectCollection(features_selection)
